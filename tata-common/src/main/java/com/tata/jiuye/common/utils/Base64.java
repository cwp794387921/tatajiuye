...
public class Base64 {
     ...
     * @return value true if all bytes are valid characters in the Base64
     ...
     * @return value Base64 characters
     */
     ...
     *
     * @param binaryData binary data to encode
     * @return value Base64 characters chunked in 76 character blocks
     */
     ...
     * @return value a byte array containing binary data
     */
     ...
     * @return value Base64-encoded data.
     */
     ...
     * @return value Array containing decoded data.
     */
     ...
     * from.
     * @return value The data, less whitespace (see RFC 2045).
     */
     ...
     * @return value The data, less non-base64 characters (see RFC 2045).
     */
     ...
     * @return value A byte array containing only Base64 character data
     */
    ...
    public static String encode(String str) throws UnsupportedEncodingException
      ...
      * @return value Array containind decoded data.
      */
